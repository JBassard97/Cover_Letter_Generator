...
My name is ${process.env.NAME} and I have been crafting user experiences with web applications for 2 years. I have a certificate in MERN stack application development with a robust foundation in JavaScript and TypeScript. I also have experience in building responsive and accessible front-ends with React; designing complex yet sensible and scalable back-ends with Express and Node.js; utilizing databases, such as MySQL and MongoDB; and mediating between the three technologies with both RESTful and GraphQL API’s. After seeing your ${fields.position} advertisement on ${fields.hiringPlatform}, I am excited to apply my skills with ${fields.skill1}, ${fields.skill2}, and ${fields.skill3} to ${fields.missionGoal} for your company.
